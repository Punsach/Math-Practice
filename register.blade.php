...
<body>
 <a style="color:white; align:center;" href="/">Back to home<a>
	<div class="container">
		<div class="content">
			<div class="title"><span class="white_text">register</span><span class="blink">|</span> </div>
			...
			<?php
				...
				DB::insert('insert into Users (Username, Password) values (?, ?)', [$username, $encryptedPassword]);  ?>
			@endif
